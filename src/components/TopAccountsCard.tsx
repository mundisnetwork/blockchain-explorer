...
import { AccountBalancePair } from "@mundis/sdk";
            ...
            <table className="table table-sm table-nowrap card-table">
              <thead>
                <tr>
                  ...
                  <th className="text-muted text-end">Balance (MUNDIS)</th>
  ...
  return (
    <tr key={index}>
      ...
      <td className="text-end">
        <MundisBalance lamports={account.lamports} maximumFractionDigits={0} />
      </td>
