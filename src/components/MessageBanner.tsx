...
announcements.set(Cluster.Devnet, {
  message: `The Mundis Devnet is in its early stages. Help us improve it by reporting any problems to our <a href="https://github.com/mundisnetwork/explorer/issues">GitHub repository</a>`,
});
