            ...
            <ul className="ml-auto">
              ...
              <li>
                ...
                >
                  <img
                    src={Discord}
                    alt="Mundis Blockchain Explorer: Discord"
                  />
                </Link>
              </li>
              <li>
                ...
                >
                  <img
                    src={Telegram}
                    alt="Mundis Blockchain Explorer: Telegram"
                  />
                </Link>
              </li>
              <li>
                ...
                >
                  <img
                    src={Twitter}
                    alt="Mundis Blockchain Explorer: Twitter"
                  />
                </Link>
              </li>
              <li>
                <Link
                  to={{
                    pathname:
                      "https://github.com/mundisnetwork/blockchain-explorer",
                  }}
                  target="_blank"
                  aria-label="Github"
                >
