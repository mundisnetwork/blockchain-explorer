          ...
          <table className="table table-sm table-nowrap card-table">
            <thead>
              <tr>
                ...
                <th className="text-muted">Effective (MUNDIS)</th>
                <th className="text-muted">Activating (MUNDIS)</th>
                <th className="text-muted">Deactivating (MUNDIS)</th>
              </tr>
            </thead>
  ...
  return (
    <tr key={index}>
      ...
      <td className="font-monospace">
        <MundisBalance lamports={entry.stakeHistory.effective} />
      </td>
      <td className="font-monospace">
        <MundisBalance lamports={entry.stakeHistory.activating} />
      </td>
      <td className="font-monospace">
        <MundisBalance lamports={entry.stakeHistory.deactivating} />
      </td>
    </tr>
  );
};
