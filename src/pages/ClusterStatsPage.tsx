...
function StatsCardBody() {
  ...
  return (
      <div className="card-body status-card">
        ...
        {blockTime && (
            <h5 className="card-header-title mt-2">Cluster time: {displayTimestampUtc(blockTime, true)}</h5>
        )}
        ...
        <div className="row mt-4">
          <div className="col-4">
            ...
            <p className="my-0">{epochProgress} complete</p>
            <p className="my-0">~{epochTimeRemaining} remaining</p>
          </div>
          <div className="col-4">
            <h4>Slot</h4>
            <Slot slot={absoluteSlot} link />
            <p className="my-0">Slot time (1min average): {averageSlotTime}ms</p>
            <p className="my-0">Slot time (1hr average): {hourlySlotTime}ms</p>
          </div>
          <div className="col-4">
            <h4>Block height</h4>
